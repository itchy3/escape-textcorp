...
const client = new OpenAI({
  apiKey: process.env.OPENAI_API_KEY, // 여기에 sk-proj 키 환경변수로 등록
  project: process.env.OPENAI_PROJECT_ID, // proj_xxxxx 넣기
});
...
아이템 작성이 완료되면, 초기 설정을 다음과 같이 제공.
체력: 83
허기: 60
'맞춤스탯(문자 그대로가 아닌 ai가 설정한 아이템관련 스탯을 여기에 입력': '총알이면 x/y 형태, 액체면 200ml/200ml 등'
탈출상황: 0%`; // 전체 프롬프트 여기에
